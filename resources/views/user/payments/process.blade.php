...
<body>
  ...
  @php
    // ⏱ Hitung sisa waktu dari backend (server source of truth)
  ...
  <script>
    ...
    // 🔁 Loop countdown tiap detik
    function tick(){
      if(remaining <= 0){
        el.innerText = "00:00";
        expiredBox.style.display = 'block'; // tampilkan pesan expired
    ...
    /* ================= AUTO EXPIRE CHECK ================= */
    // 🔄 Sinkronisasi dengan server (biar tidak beda waktu)
    setInterval(()=>{
    ...
    /* ================= AUTO STATUS CHECK ================= */
    // 🔄 Cek status pembayaran (API / gateway)
    ...
    /* ================= GLOBAL STATUS CHECK ================= */
    // 🔄 fallback: cek semua pembayaran user (anti miss update)
    setInterval(() => {
