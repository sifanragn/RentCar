...
Route::middleware(['guest', PreventBackHistory::class])->group(function () {
    ...
    // Redirect jika akses GET ke send-otp
    Route::get('/register/send-otp', function () {
...
Route::prefix('admin')->middleware('admin.session')->name('admin.')->group(function () {
    ...
    // Social Media
    Route::get('/social-media', [AdminSocialController::class, 'index'])->name('social.index');
    Route::get('/social-media/{id}', [AdminSocialController::class, 'show'])->name('social.show');
